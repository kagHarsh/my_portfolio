...
const Social = () => {
    return (
        <div className="home__social">
            <a href="https://www.linkedin.com/in/harsh-kag-163182155/" className="home__social-icon" target="_blank"><i class="uil uil-linkedin"></i></a>
            <a href="https://github.com/kagHarsh" className="home__social-icon" target="_blank"><i class="uil uil-github"></i></a>
            <a href="https://leetcode.com/HarshKag/" className="home__social-icon" target="_blank">
            ...
            <a href="https://auth.geeksforgeeks.org/user/kagharsh/practice" className="home__social-icon" target="_blank">
            ...
            <a href="https://www.instagram.com/harshkag22/" className="home__social-icon" target="_blank"><i class="uil uil-instagram"></i></a>
        </div>
    )
