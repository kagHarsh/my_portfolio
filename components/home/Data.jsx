...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <p className="home__description">Welcome to my portfolio—a testament to my academic journey, showcasing my achievements, growth, and unwavering commitment to learning.</p>
